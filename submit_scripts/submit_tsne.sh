...
python /netapp/home/mincheol/scVI-extensions/scripts/tsne_comparison.py \
	--model_path=/netapp/home/mincheol/vaec_model_vargenes_kogene.model \
	--model_label gene \
	--label gene \
	--n_genes 1000 \
	...
	--n_samples 100000 \
	--output /ye/yelabstore2/mincheol/outputs/scvi/tsne_guide
source deactivate
